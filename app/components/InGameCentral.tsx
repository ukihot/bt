...
import { useOminousHandlers } from "../hooks/useOminousHandlers";

export const InGameCentral = () => {
    ...
    const ominousHandlers = useOminousHandlers(context);

    const handleOminous = useCallback(
        (terminal: Terminal) => {
            // 招かざる者
            ominousHandlers.handleSorryMan(terminal.id);
            // 動いていけない
        },
        [ominousHandlers],
    );
